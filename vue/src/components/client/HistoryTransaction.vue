...
import { historyTransactions } from "../../services/api/history";
  ...
  methods: {
    ...
    createPgn() {
      ...
      function createPagination(totalPage, page) {
        ...
        if (page > 1 && page == 2) {
          //show the next button if the page value is greater than 1
          liTag += `<a href="/user/history-transaction/"><li class="btn prev"><span><i class="fas fa-angle-left"></i> Prev</span></li></a>`;
        }

        if (page > 2 && totalPage > 4) {
          //if page value is less than 2 then add 1 after the previous button
          liTag += `<a href="/user/history-transaction/"><li class="first numb"><span>1</span></li></a>`;
