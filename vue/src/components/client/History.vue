...
export default {
  ...
  methods: {
    download(text) {
      ...
      var filename =  currentdate.getFullYear().toString() +currentdate.getDate().toString() +(currentdate.getMonth()+1).toString()+currentdate.getHours().toString()+currentdate.getMinutes().toString()+currentdate.getSeconds().toString()+".txt"
      console.log((currentdate.getMonth()+1)+ currentdate.getFullYear())
